...
type 
(*----------------------------------------------------------------------------*)
  TPSImport_jvuibconst = class(TPSPlugin)
  protected
...
procedure SIRegister_jvuibconst(CL: TPSPascalCompiler);
...
procedure Register;
begin
  RegisterComponents('Pascal Script', [TPSImport_jvuibconst]);
end;
...
{ TPSImport_jvuibconst }
(*----------------------------------------------------------------------------*)
procedure TPSImport_jvuibconst.CompileImport1(CompExec: TPSScript);
begin
  SIRegister_jvuibconst(CompExec.Comp);
end;
(*----------------------------------------------------------------------------*)
