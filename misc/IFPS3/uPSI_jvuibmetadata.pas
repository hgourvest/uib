...
type 
(*----------------------------------------------------------------------------*)
  TPSImport_jvuibmetadata = class(TPSPlugin)
  protected
...
procedure SIRegister_jvuibmetadata(CL: TPSPascalCompiler);
...
procedure RIRegister_jvuibmetadata(CL: TPSRuntimeClassImporter);
...
procedure Register;
begin
  RegisterComponents('Pascal Script', [TPSImport_jvuibmetadata]);
end;
...
begin
  ...
  begin
    ...
    RegisterMethod('Procedure LoadFromDatabase( Transaction : TJvUIBTransaction)');
...
{ TPSImport_jvuibmetadata }
(*----------------------------------------------------------------------------*)
procedure TPSImport_jvuibmetadata.CompileImport1(CompExec: TPSScript);
begin
  SIRegister_jvuibmetadata(CompExec.Comp);
end;
(*----------------------------------------------------------------------------*)
procedure TPSImport_jvuibmetadata.ExecImport1(CompExec: TPSScript; const ri: TPSRuntimeClassImporter);
begin
  RIRegister_jvuibmetadata(ri);
end;
(*----------------------------------------------------------------------------*)
