...
type 
(*----------------------------------------------------------------------------*)
  TPSImport_jvuiblib = class(TPSPlugin)
  protected
...
procedure SIRegister_jvuiblib(CL: TPSPascalCompiler);
...
procedure RIRegister_jvuiblib(CL: TPSRuntimeClassImporter);
...
procedure Register;
begin
  RegisterComponents('Pascal Script', [TPSImport_jvuiblib]);
end;
...
{ TPSImport_jvuiblib }
(*----------------------------------------------------------------------------*)
procedure TPSImport_jvuiblib.CompileImport1(CompExec: TPSScript);
begin
  SIRegister_jvuiblib(CompExec.Comp);
end;
(*----------------------------------------------------------------------------*)
procedure TPSImport_jvuiblib.ExecImport1(CompExec: TPSScript; const ri: TPSRuntimeClassImporter);
begin
  RIRegister_jvuiblib(ri);
end;
(*----------------------------------------------------------------------------*)
