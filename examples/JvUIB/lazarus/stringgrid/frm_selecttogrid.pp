...
{                                                                              }
{------------------------------------------------------------------------------}
{ Sample for use the components TjvUIBDatabase,TjvUIBTransaction et TjvUIBQuery}
...
type
  TForm1 = class(TForm)
    ...
    edDataBase: TEdit;
    SG: TStringGrid;
    UIBBase: TJvUIBDataBase;
    Qry: TJvUIBQuery;
    UIBTrs: TJvUIBTransaction;
    Label1: TLabel;
    moSQL: TMemo;
    Panel1: TPanel;
    Panel2: TPanel;
