...
(*                                                                              *)
(********************************************************************************)
(* $Id: jvuibsqledit.pas,v 1.9 2004/12/26 18:13:45 progdigy Exp $ *)
(********************************************************************************)
...
{$IFDEF MSWINDOWS}
  ...
  ComCtrls, jvuib, jvuibmetadata, jvuibsynedit, ExtCtrls, ImgList, SynEdit,
  ToolWin, Grids, StdCtrls, jvuiblib, SynCompletionProposal, SynEditTypes;
{$ELSE}
  QForms, QSynCompletionProposal, QImgList, QStdCtrls, QExtCtrls, QGrids,
  QControls, QComCtrls, QSynEdit, Classes, jvuiblib, jvuib, jvuibmetadata,
  jvuibsynedit, SysUtils, libc, QSynEditTypes, SynCompletionProposal;
{$ENDIF}
type
  ...
  private
    ...
    procedure SetStatement(const Value: TJvUIBStatement);
    procedure CheckTransaction;
  public
    property Statement: TJvUIBStatement Read FStatement write SetStatement;
  end;
...
procedure TUIBSQLEditForm.SetStatement(const Value: TJvUIBStatement);
