...
(*                                                                              *)
(********************************************************************************)
(* $Id: jvuibsynedit.pas,v 1.9 2005/10/15 01:36:15 progdigy Exp $ *)
(********************************************************************************)
...
{$IFDEF MSWINDOWS}
  ...
  SynHighlighterHashEntries, SynEditStrConst, jvuibmetadata;
{$ELSE}
  ...
  QSynHighlighterHashEntries, QSynEditStrConst, jvuibmetadata;
{$ENDIF}
