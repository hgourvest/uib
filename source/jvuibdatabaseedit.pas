...
{$IFDEF UNIX}
  ...
  QStdCtrls, QExtCtrls, jvuib, jvuiblib, jvuibase, QCheckLst, QMenus;
{$ELSE}
  Windows, Messages, SysUtils, Classes, Graphics, Controls, Forms, Dialogs,
  StdCtrls, ExtCtrls, jvuib, jvuiblib, jvuibase, CheckLst, Menus;
{$ENDIF}
...
type
  ...
  private
    ...
    procedure SetDatabase(Database: TJvUIBDataBase);
...
procedure TUIBDatabaseEditForm.SetDatabase(Database: TJvUIBDataBase);
var
  Idx1, Idx2: Integer;
  st: string;
