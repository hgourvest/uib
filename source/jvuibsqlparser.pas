...
(*                                                                              *)
(********************************************************************************)
(* $Id: jvuibsqlparser.pas,v 1.10 2005/10/15 01:36:15 progdigy Exp $             *)
(********************************************************************************)
...
constructor TJVUIBSQLParser.Create(AStrings: TStrings);
begin
  Assert(AStrings <> nil);
...
destructor TJVUIBSQLParser.Destroy;
begin
  FParams.Free;
  inherited;
end;

procedure TJVUIBSQLParser.Error(const msg: string = '');
...
function TJVUIBSQLParser.GetStatement: string;
var
  i: integer;
  str: string;
begin
...
function TJVUIBSQLParser.NextLine: boolean;
begin
  inc(FLine);
...
function TJVUIBSQLParser.NextToken: TSQLToken;
label next;
var p: PChar;
  function get: char;
  begin
