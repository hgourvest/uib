...
type
  TJvUIBScriptBuilder = class(TJvUIBComponent)
  private
    FDB: TJvUIBDataBase;
  ...
  published
    property Database: TJvUIBDatabase read FDB write FDB;
...
constructor TJvUIBScriptBuilder.Create(AOwner: TComponent);
begin
  inherited;
...
destructor TJvUIBScriptBuilder.Destroy;
begin
...
procedure TJvUIBScriptBuilder.BuildInsertScript(const TableName: String);
var
  OrgTable: TMetaTable;
begin
...
function TJvUIBScriptBuilder.GetMetadatas: TMetaDataBase;
var
  T: TJvUIBTransaction;
begin
...
function TJvUIBScriptBuilder.GetScript: TStrings;
begin
  Result := FScript;
end;

function TJvUIBScriptBuilder.MakeFBDate(ADate: TDateTime): String;
begin
  Result := FormatDateTime('yyyy-mm-dd',ADate);
end;

function TJvUIBScriptBuilder.MakeFBTime(ATime: TDateTime): String;
begin
  Result := FormatDateTime('hh:nn:ss.zzz',ATime);
end;

function TJvUIBScriptBuilder.MakeFBTimeStamp(ADateTime: TDateTime): String;
begin
  Result := FormatDateTime('yyyy-mm-dd hh:nn:ss.zzz',ADateTime);
end;

procedure TJvUIBScriptBuilder.BuildInsertSQL(Table: TMetaTable; const SQL: String);
var
...
procedure TJvUIBScriptBuilder.ExportTable(Table: TMetaTable);
var
  sql: String;
  i, f: Integer;
