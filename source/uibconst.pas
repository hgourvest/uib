...
{$IFDEF UIBLANG_CZ}
  ...
  EUIB_DBHANDLEALREADYSET  = 'Kanál databáze je ji pøipraven, nejdøíve odpojte databázi.';
  ...
  EUIB_FIELDNUMNOTFOUND    = 'Poloka èíslo: %d neexistuje.';
  ...
  EUIB_FETCHBLOBNOTSET     = 'Vlastnost FetchBlob musí být nastavena pro pouití této metody.';
  EUIB_INDEXERROR          = 'Index je mimo rozsah (%d)';
  EUIB_SIZENAME            = 'Velikost názvu je pøíli velká (%s)';
...
{$IFDEF UIBLANG_HU}
  ...
  // UIB Errors
  EUIB_INVALIDEIBVERSION   = 'Inkorrekt Adatbázis Szerver verzió! Ellenőrizd a fordítói opciókat.';
  EUIB_CANTLOADLIB         = 'Nem lehet betölteni ezt a függvénytárat: %s.';
  EUIB_DBHANDLEALREADYSET  = 'Az adatbázis kezelő (handle) már hozzá lett rendelve! Előbb kapcsolódj le.';
  EUIB_TRANSACTIONNOTDEF   = 'Nincs tranzakció hozzárendelve.';
  EUIB_DATABASENOTDEF      = 'Nincs adatbázis hozzárendelve.';
  EUIB_QUERYNOTOPEN        = 'Nincs nyitva a Lekérdezés (Query).';
  EUIB_CASTERROR           = 'Típus Megfeleltetési (Cast) hiba.';
  EUIB_UNEXPECTEDERROR     = 'Váratlan hiba.';
  EUIB_FIELDNUMNOTFOUND    = 'Ez a mező szám: %d nem található.';
  EUIB_FIELDSTRNOTFOUND    = 'Ez a mező: "%s" nem található.';
  EUIB_PARAMSTRNOTFOUND    = 'Ez a paraméter: "%s" nem található.';
  EUIB_BLOBFIELDNOTFOUND   = 'Ez a Blob-mező szám: %d nem található.';
  EUIB_FETCHBLOBNOTSET     = 'A "FetchBlob" tulajdonságnak be kell lennie állítva, hogy ezt a ez a metódus használható legyen.';
  EUIB_INDEXERROR          = 'A számozás határértéken túli (%d)';
  EUIB_SIZENAME            = 'A Név túl hosszú (%s)';
  EUIB_MUSTBEPREPARED      = 'A Lekérdezést előbb preparálni kell.';
  EUIB_MUSTBEOPEN          = 'A Lekérdezést előbb meg kell nyitni.';
  EUIB_EXPLICITTRANS       = 'A Transakciót explicit módon kell elindítani.';
  EUIB_EXCEPTIONNOTFOUND   = 'Ez a Hibakezelési név: "%s" nem található.';
  EUIB_EXPTIONREGISTERED   = 'Ez a Hibakezelési név: "%s" már regisztálva lett.';
  EUIB_NOAUTOSTOP          = 'A Transakciót explicit módon kell lezárni.';
  EUIB_NOGENERATOR         = 'Ez a Generator: "%s" nem található.';
  EUIB_NOFIELD             = 'A mező nem található.';
  EUIB_TABLESTRNOTFOUND    = 'Ez a Tábla: "%s" nem található.';
  EUIB_DOMAINSTRNOTFOUND   = 'Ez a Tartomány (Domain): %s nem található.';
  EUIB_PROCSTRNOTFOUND     = 'Ez az Eljárás (Procedure): %s nem található.';
  EUIB_CACHEDFETCHNOTSET   = 'A "CachedFetch" tulajdonság Hamisra állítva.';
  EUIB_PARSESQLDIALECT     = 'Feldolgozási (Parse) hiba: SET SQL DIALECT';
  EUIB_PARSESETNAMES       = 'Feldolgozási (Parse) hiba: SET NAMES';
  EUIB_CHARSETNOTFOUND     = 'Ez a Karakter-tábla: "%s" nem található.';
  EUIB_UNEXPECTEDCASTERROR = 'Váratlan mező-konvertálási (cast) hiba.';
  EUIB_INVALIDUSERNAME     = 'Helytelen felhasználó név: "%s".';
  EUIB_SERVICESPARSING     = 'Hiba történt a Szolgáltató API kimenetének adatfeldolgozása (parse) során.';
  EUIB_NOT_NULLABLE        = 'Ezen Mező: "%s" értéke nem lehet [NULL] !';
{$ENDIF UIBLANG_HU}
